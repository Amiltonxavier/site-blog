                ...
                <div className="grid gap-8 md:grid-cols-2">
                    {
                        customerStories.map((customerStory) => (
                            <div key={customerStory.author.name} className="border-2 border-gray-600 flex flex-col gap-6 rounded-lg bg-gray-500 p-6 md:p-12 ">
                                <p className="italic text-balance text-gray-200">
